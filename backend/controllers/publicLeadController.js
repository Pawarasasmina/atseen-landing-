...
const confirmationEmailCopy = {
  en: {
    ...
    notice: 'Your private invitation will arrive here when registration opens. No action is needed.',
  ...
  ar: {
    ...
    notice: 'ستصل دعوتك الخاصة هنا عند فتح التسجيل. لا يلزم اتخاذ أي إجراء.',
  ...
  ru: {
    ...
    notice: 'Когда откроется регистрация, ваше личное приглашение придёт сюда. Больше ничего делать не нужно.',
  ...
  es: {
    ...
    notice: 'Tu invitación privada llegará aquí cuando se abra el registro. No tienes que hacer nada más.',
  ...
  fr: {
    ...
    notice: 'Votre invitation privée arrivera ici à l’ouverture des inscriptions. Vous n’avez rien d’autre à faire.',
  ...
  pt: {
    ...
    notice: 'Seu convite privado chegará aqui quando as inscrições abrirem. Você não precisa fazer mais nada.',
