...
const applicationLimiter = rateLimit({ windowMs: 60 * 60 * 1000, limit: 17, standardHeaders: 'draft-7', legacyHeaders: false, message: { success: false, message: 'You can submit up to 3 applications per hour. Please try again later.' } });
